...
export const squareLayout: RoomPlannerLayoutTemplate = {
    ...
    build: {
        ...
        road: [{ x: 0, y: 0 }, { x: -1, y: -1 }, { x: -2, y: -2 }, { x: -3, y: -3 }, { x: 1, y: -1 }, { x: -2, y: 0 }, { x: -3, y: 0 }, { x: -4, y: 0 }, { x: -5, y: 0 }
            ...
            , { x: 2, y: 0 }, { x: 3, y: 0 }, { x: 4, y: 0 }, { x: 5, y: 0 }, { x: 5, y: 1 }, { x: 5, y: 2 }, { x: 5, y: 3 }, { x: 5, y: 4 }, { x: 5, y: 5 }, { x: 5, y: -1 }
            , { x: 5, y: -2 }, { x: 5, y: -3 }, { x: 5, y: 4 }, { x: 5, y: -5 }, { x: -5, y: -1 }, { x: -5, y: -2 }, { x: -5, y: -3 }, { x: -5, y: -4 }, { x: -5, y: -5 }
